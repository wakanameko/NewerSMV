...
class SpriteImage_NewerSwitch(common.SpriteImage_Switch):
    ...
    def dataChanged(self):
        ...
        if self.styleType == 1 or self.styleType > 6:
            self.styleType = 0
...
class SpriteImage_DryBonesNew(SLib.SpriteImage_StaticMultiple):  # 490
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (-3, -16)
...
class SpriteImage_DryBonesWing(SLib.SpriteImage_StaticMultiple):  # 491
    def __init__(self, parent):
        super().__init__(parent)
        self.offset = (-4, -16)
...
class SpriteImage_BossMadPiano(SLib.SpriteImage_StaticMultiple):  # 492
    @staticmethod
    def loadImages():
        if 'MadPiano' in ImageCache: return
        ImageCache[f'MadPiano'] = SLib.GetImg(f'MadPiano.png')

    def dataChanged(self):
        self.image = ImageCache[f'MadPiano']
        self.offset = (-48, -55)

        super().dataChanged()

class SpriteImage_NSLULS(SLib.SpriteImage_StaticMultiple):  # 495
    @staticmethod
    def loadImages():
        if 'Goombrat0' in ImageCache: return
        for i in range(1):
    ...
    def dataChanged(self):
        ...
        color = (self.parent.spritedata[1] & 0xF)
...
class SpriteImage_ITEMBALLOON(SLib.SpriteImage_StaticMultiple):  # 501
    @staticmethod
    def loadImages():
        if 'ItemBalloon0' in ImageCache: return
        for i in range(10):
            ImageCache[f'ItemBalloon{i}'] = SLib.GetImg(f'ItemBalloon_{i}.png')

    def dataChanged(self):

        color = (self.parent.spritedata[5] & 0xF)

        self.image = ImageCache[f'ItemBalloon{color}']
        self.offset = (-21, -30)

        super().dataChanged()
        
class SpriteImage_smwBossBigBoo(SLib.SpriteImage):  # 503
    def __init__(self, parent):
        super().__init__(parent, 1.5)
        self.spritebox.shown = False
...
class SpriteImage_SpikeTrap(SLib.SpriteImage_StaticMultiple):  # 504
    def __init__(self, parent):
        super().__init__(parent)
...
class SpriteImage_ActorSpawnerNewer(SLib.SpriteImage_Static):  # 505
    def __init__(self, parent):
        super().__init__(
            parent,
            1.5,
...
class SpriteImage_Komboo(SLib.SpriteImage_Static):  # 506
    SIZES = ['s', 'm']
...
class SpriteImage_AngrySunChild(SLib.SpriteImage_StaticMultiple):  # 508
    @staticmethod
    def loadImages():
        SLib.loadIfNotInImageCache('AngrySun', 'angry_sun.png')
        SLib.loadIfNotInImageCache('AngryMoon', 'angry_moon.png')
...
ImageClasses = {
    ...
    # start of more sprites patches below
    487: SpriteImage_Koton,  
    488: SpriteImage_Goombrat,  
    489: SpriteImage_DragonCoins,  
    490: SpriteImage_DryBonesNew,  
    491: SpriteImage_DryBonesWing,  
    492: SpriteImage_BossMadPiano, 
    495: SpriteImage_NSLULS, 
    501: SpriteImage_ITEMBALLOON,
    503: SpriteImage_smwBossBigBoo,
    504: SpriteImage_SpikeTrap,
    505: SpriteImage_ActorSpawnerNewer,
    506: SpriteImage_Komboo,
    508: SpriteImage_AngrySunChild,
}
