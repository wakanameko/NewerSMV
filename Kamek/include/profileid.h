...
enum
{
    ...
    */
	...
	TALKBALLOON = 483,						// 483	Asu-chan
	OshaberiFlower = 484,					// 484	wakanameko
	NEWER_SFXGFXSPAWNER = 485,				// 485	Asu-chan
	SMWTogezo = 486,						// 486	ReaZ0n
	koton = 487,    						// 487	wakanameko
	Goombrat = 488,    						// 488	Synel
	smwDCoin = 489,    						// 489	ReaZ0n
    DryBones = 490,                         // 490  Synel
    ParaBones = 491,                        // 491  Synel
    BossMadPiano = 492,                     // 492  wakanameko
    iceBallFake = 493,                      // 493  wakanameko
    catGoomba = 494,                        // 494  wakanameko
    nsluLogoSign = 495,                     // 495  wakanameko
    PakkunProjectile = 496,                 // 496  Synel, RedStoneMatt, Nin0
    minigameCollectStarMgr = 497,           // 497  wakanameko
    minigameToadMgr = 498,                  // 498  wakanameko
    MESSAGEWINDOW = 499,                    // 499  wakanameko
    ITEMBOWLINGMGR = 500,                   // 500  Asu-chan    // Item Bowling Stuff
    ITEMBALLOON = 501,                      // 501  Asu-chan    // Item Bowling Stuff
    SHELLWARPER = 502,                      // 502  Asu-chan    // Item Bowling Stuff
    SMW_BOSSBIGBOO = 503,                   // 503  ReaZ0n
    SpikeTrap = 504,                        // 504  Synel
    NEWER_ACTORSPAWNER = 505,               // 505  Chickensaver
    Konbu = 506,                            // 506  Synel
    KonbuSpawner = 507,                     // 507  Synel
    BossChildSM = 508,                      // 508  wakanameko
...
enum
{
    ...
    // Start of custom entries
	TALKBALLOON = 750,						// 750	Asu-chan
	OshaberiFlower = 751,					// 751	wakanameko
	NEWER_SFXGFXSPAWNER = 752,				// 752	Asu-chan
	SMWTogezo = 753,						// 753	ReaZ0n
	koton = 754,						    // 754	wakanameko
    Goombrat = 755,                         // 755  Synel
    smwDCoin = 756,                         // 756  ReaZ0n
    DryBones = 757,                         // 757  Synel
    ParaBones = 758,                        // 758  Synel
    BossMadPiano = 759,                     // 759  wakanameko
    iceBallFake = 760,                      // 760  wakanameko
    catGoomba = 761,                        // 761  wakanameko
    nsluLogoSign = 762,                     // 762  wakanameko
    PakkunProjectile = 763,                 // 763  Synel, RedStoneMatt, Nin0
    minigameCollectStarMgr = 764,           // 764  wakanameko
    minigameToadMgr = 765,                  // 765  wakanameko
    MESSAGEWINDOW = 766,                    // 766  wakanameko
    ITEMBOWLINGMGR = 767,                   // 767  Asu-chan    // Item Bowling Stuff
    ITEMBALLOON = 768,                      // 768  Asu-chan    // Item Bowling Stuff
    SHELLWARPER = 769,                      // 769  Asu-chan    // Item Bowling Stuff
    SMW_BOSSBIGBOO = 770,                   // 770  ReaZ0n
    SpikeTrap = 771,                        // 771  Synel
    NEWER_ACTORSPAWNER = 772,               // 772  Chickensaver
    Konbu = 773,                            // 773  Synel
    KonbuSpawner = 774,                     // 774  Synel
    BossChildSM = 775,                      // 775  wakanameko
