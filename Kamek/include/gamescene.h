#ifndef __KAMEK_GAMESCENE_H
#define __KAMEK_GAMESCENE_H

class dGameDisplay_c : dBase_c {         //The dGameDisplay_c class, it was RE'd by Grop (because i was a noob back when he did it), thanks to him !
    public:
