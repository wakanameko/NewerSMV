...
ContinueFromFuckLineLiftActivation = 0x808398A4;

GabonRock_DropOutState = 0x80998610;
GabonRock_CrushState = 0x809985D0;
...
TogeTekkyuIceballCollision = 0x80AB66C0;
_8042A788 = 0x8042A1C8;
sub_8019C390 = 0x8019C060;

_ZN24daEnBossKoopaDemoPeach_c12StateID_WaitE = 0x80B8BC70;
StateID_Wait__24daEnBossKoopaDemoPeach_c = 0x80B8BC70;
_ZN24daEnBossKoopaDemoPeach_c12StateID_CallE = 0x80B8BCB0;
StateID_Call__24daEnBossKoopaDemoPeach_c = 0x80B8BCB0;
_ZN24daEnBossKoopaDemoPeach_c12StateID_TurnE = 0x80B8BCF0;
StateID_Turn__24daEnBossKoopaDemoPeach_c = 0x80B8BCF0;
_ZN24daEnBossKoopaDemoPeach_c12StateID_OpenE = 0x80B8BD30;
StateID_Open__24daEnBossKoopaDemoPeach_c = 0x80B8BD30;
_ZN24daEnBossKoopaDemoPeach_c14StateID_RescueE = 0x80B8BD70;
StateID_Rescue__24daEnBossKoopaDemoPeach_c = 0x80B8BD70;
_ZN24daEnBossKoopaDemoPeach_c13StateID_ThankE = 0x80B8BDB0;
StateID_Thank__24daEnBossKoopaDemoPeach_c = 0x80B8BDB0;
...
ContinueFromJustOneBomb = 0x80A11CCC;

_Z14SmoothRotationPsss = 0x8015F300;
SmoothRotation__FPsss = 0x8015F300;

KazanRock_OriginalCollisionCallback = 0x8081F1C0;
KazanRock_Explode = 0x8081EF30;
...
_ZN12dStockItem_c25getIconPictureIDforPlayerEi = 0x807AF930;
getIconPictureIDforPlayer__12dStockItem_cFi = 0x807AF930;
...
ContinueFromSILayoutExtraStuffs = 0x807AF748;
ContinueFromResetHammerAnimOnOpen = 0x807B08DC;
ContinueFromHideItemsByDefault = 0x807AF5E0;
MakeSFISound = 0x807B05E4;
ContinueFromSIAddSound = 0x807B0640;
ChosenStartChoice = 0x807B0AA4;
ContinueFromSISLayoutExtraStuffs = 0x807B2000;
ContinueFromUpdateSIS = 0x807B22C8;
...
continueFromStrongBox2 = 0x808AAD70;
continueFromStrongBox = 0x808AA278;
...
_Z23StockWMInit_LoadEffectsPv = 0x80926860;
StockWMInit_LoadEffects__FPv = 0x80926860;
...
_Z13GetBMGMessageii = 0x800CDBC0;
GetBMGMessage__Fii = 0x800CDBC0;
...
_Z20WriteNumberToTextBoxPjS_PN4nw4r3lyt7TextBoxEb = 0x800B3B60;
...
_ZN20daJrClownForPlayer_cC1Ev = 0x80810220;
__ct__20daJrClownForPlayer_cFv = 0x80810220;
_ZN20daJrClownForPlayer_cD1Ev = 0x808102E0; /* Beans indeed. */
__dt__20daJrClownForPlayer_cFv = 0x808102E0; /* Beans indeed. */

PClownCarExecute = 0x800A3600;
PClownCarAfterCreate = 0x800951D0;
PClownCarDraw = 0x80810930;
PClownCarMove = 0x80811C10;
ContinueFromClownCarDetectAdjacent = 0x80811EA4;
...
MagicEnd = 0x807CCBB0;
KeyLoopSet = 0x80804420;

/* Some collision shit for giant shy guys */

BigHanaPlayer = 0x809B21E0;
BigHanaYoshi = 0x809B23F0;
BigHanaWeirdGP = 0x809B26A0;
BigHanaGroundPound = 0x809B2610;
BigHanaFireball = 0x809B3370;
BigHanaIceball = 0x809B3340;
...
Cloud_death_execute = 0x809DD4A0;
Cloud_execute = 0x809DF660;
...
BombSleepState = 0x80B123A8;
NoFreezie = 0x800A0B08;
GameTimer = 0x80429D90;
GameTimerB = 0x80D25518;

EightyPointZero = 0x8042B4A8;
OneHundredPointZero = 0x8042C780;
...
_ZN13daObjKinoko_c17original_onCreateEv = 0x8087F670;
original_onCreate__13daObjKinoko_cFv = 0x8087F670;
...
EN_LandbarrelPlayerCollision = 0x80A57BC0;

/* Boss Related */
_ZN16dStageActorMgr_c8instanceE = 0x80429A68;
instance__16dStageActorMgr_c = 0x80429A68;

StartBGMMusic = 0x807DB1C0;
StopBGMMusic = 0x807DB1D0;
...
MakeMarioEnterDemoMode = 0x807C7CF0;
...
_ZN12daKameckDemo15StateID_DemoSt2E = 0x80999524;
StateID_DemoSt2__12daKameckDemo = 0x80999524;
_ZN12daKameckDemo14StateID_DemoStE = 0x80999564;
StateID_DemoSt__12daKameckDemo = 0x80999564;
_ZN12daKameckDemo16StateID_DemoWaitE = 0x809995A4;
StateID_DemoWait__12daKameckDemo = 0x809995A4;

_ZN13daBossKoopa_c12StateID_FallE = 0x80B8B8CC;
StateID_Fall__13daBossKoopa_c = 0x80B8B8CC;

_ZN9daNeedles16StateID_DemoWaitE = 0x8099C8AC;
StateID_DemoWait__9daNeedles = 0x8099C8AC;
_ZN9daNeedles17StateID_DemoAwakeE = 0x8099C8F0;
StateID_DemoAwake__9daNeedles = 0x8099C8F0;
_ZN9daNeedles12StateID_IdleE = 0x8099C930;
StateID_Idle__9daNeedles = 0x8099C930;
_ZN9daNeedles11StateID_DieE = 0x8099C970;
StateID_Die__9daNeedles = 0x8099C970;
...
PlayWrenchSound = 0x808A9260;
WaterManager = 0x80429E20;
CheckforLiquid = 0x800EB8B0;

BowserFireballCollision = 0x80B7E160;
BowserDamageAnmClr = 0x80B3EB20;
BowserDamageStepTwo = 0x80B1F1F0;
BowserDamageNormal = 0x80B1F210;
BowserDamageKill = 0x80098D80;
BowserDamageEnd = 0x80B3EE50;
...
PlaySoundWithFunctionB4_2 = 0x80194EB4;
...
_ZN17SoundPlayingClass12sub_801994D0EijP4VEC2j = 0x801991A0;
sub_801994D0__17SoundPlayingClassFiUiP4VEC2Ui = 0x801991A0;
...
_ZN13dStageActor_c5_vf8CEPv = 0x80065870;
...
spinningPhysicsCallback = 0x808A2120;
/* = 0x808A2120; */
...
_ZN3m2d13EmbedLayout_c9resetAnimEii = 0x800C9350;
resetAnim__Q23m2d13EmbedLayout_cFii = 0x800C9350;
_ZN3m2d13EmbedLayout_c20disableAllAnimationsEv = 0x800C9480;
disableAllAnimations__Q23m2d13EmbedLayout_cFv = 0x800C9480;
_ZN3m2d13EmbedLayout_c11disableAnimEi = 0x800C9410;
...
_ZN3m3d9scnLeaf_c13setDrawMatrixEPA3_A4_f = 0x80169F80;
setDrawMatrix__Q23m3d9scnLeaf_cFPA3_A4_f = 0x80169F80;
_ZN3m3d9scnLeaf_c9calcWorldEb = 0x80169FB0;
calcWorld__Q23m3d9scnLeaf_cFb = 0x80169FB0;
_ZN3m3d9scnLeaf_c8setScaleEP4VEC3 = 0x80169F60;
setScale__Q23m3d9scnLeaf_cFP4VEC3 = 0x80169F60;
/* End preliminary section */

_ZTVN3m3d6bmdl_cE = 0x8032935C;
__vt__Q23m3d6bmdl_c = 0x8032935C;
_ZN3m3d6bmdl_cD1Ev = 0x80167F10;
__dt__Q23m3d6bmdl_cFv = 0x80167F10;

_ZTVN3m3d6smdl_cE = 0x803293F4;
__vt__Q23m3d6smdl_c = 0x803293F4;
_ZN3m3d6smdl_cC1Ev = 0x8016A100;
__ct__Q23m3d6smdl_cFv = 0x8016A100;
_ZN3m3d6smdl_cD1Ev = 0x8016A150;
__dt__Q23m3d6smdl_cFv = 0x8016A150;
_ZN3m3d6smdl_c5setupEN4nw4r3g3d6ResMdlEPvjjj = 0x8016A1B0; /*addAnyway*/
...
_ZN16mHeapAllocator_c24linkAndBecomeCurrentHeapEiPvPKcii = 0x8016A770;
linkAndBecomeCurrentHeap__16mHeapAllocator_cFiPvPCcii = 0x8016A770;
_ZN16mHeapAllocator_c24linkAndBecomeCurrentHeapEiPvPKcij = 0x8016A770; /*addAnyway*/
_ZN16mHeapAllocator_c4doneEv = 0x8016A7C0;
done__16mHeapAllocator_cFv = 0x8016A7C0;
...
_Z22randomiseNormalTerrainP12TilemapClassP8BGRenderi = 0x80085E80;
randomiseNormalTerrain__FP12TilemapClassP8BGRenderi = 0x80085E80;
_Z19randomiseSubTerrainP12TilemapClassP8BGRenderi = 0x80085FF0;
randomiseSubTerrain__FP12TilemapClassP8BGRenderi = 0x80085FF0;
_Z15randomiseNoharaP12TilemapClassP8BGRenderi = 0x80086160;
randomiseNohara__FP12TilemapClassP8BGRenderi = 0x80086160;
_Z15randomiseSabakuP12TilemapClassP8BGRenderi = 0x800861C0;
randomiseSabaku__FP12TilemapClassP8BGRenderi = 0x800861C0;
_Z13randomiseGakeP12TilemapClassP8BGRenderi = 0x800861D0;
randomiseGake__FP12TilemapClassP8BGRenderi = 0x800861D0;
_Z15randomiseKaiganP12TilemapClassP8BGRenderi = 0x80086370;
randomiseKaigan__FP12TilemapClassP8BGRenderi = 0x80086370;
_Z16randomiseDoukutuP12TilemapClassP8BGRenderi = 0x800866B0;
randomiseDoukutu__FP12TilemapClassP8BGRenderi = 0x800866B0;
_Z19randomiseShiroBoss1P12TilemapClassP8BGRenderi = 0x800866C0;
randomiseShiroBoss1__FP12TilemapClassP8BGRenderi = 0x800866C0;
_Z14randomiseObakeP12TilemapClassP8BGRenderi = 0x80086750;
randomiseObake__FP12TilemapClassP8BGRenderi = 0x80086750;
_Z18randomiseObakeSotoP12TilemapClassP8BGRenderi = 0x80086760;
randomiseObakeSoto__FP12TilemapClassP8BGRenderi = 0x80086760;
_Z18randomiseKoriChikaP12TilemapClassP8BGRenderi = 0x800868E0;
randomiseKoriChika__FP12TilemapClassP8BGRenderi = 0x800868E0;
_Z16randomisePa2KoriP12TilemapClassP8BGRenderi = 0x80086A60;
...
_Z8SaveGamePvb = 0x8092F340;
SaveGame__FPvb = 0x8092F340;
...
_Z20GameSetup__LoadScenePv = 0x809192B0;
GameSetup__LoadScene__FPv = 0x809192B0;
_Z9FreeScenei = 0x801646C0;
FreeScene__Fi = 0x801646C0;
_Z17GameSetupDrawFuncv = 0x809176E0;
GameSetupDrawFunc__Fv = 0x809176E0;
_Z16WorldMapDrawFuncv = 0x809264C0;
WorldMapDrawFunc__Fv = 0x809264C0;
...
LoadBlight = 0x80919640;
LoadBlmap = 0x80919630;
...
_Z8mbstowcsPwPKcm = 0x802DEC0C;
mbstowcs__FPwPCcUl = 0x802DEC0C;
...
/* m3d::anmVis_c */
_ZTVN3m3d8anmVis_cE = 0x80AD7A78;
__vt__Q23m3d8anmVis_c = 0x80AD7A78;
_ZN3m3d8anmVis_cD1Ev = 0x809B19B0;
__dt__Q23m3d8anmVis_cFv = 0x809B19B0;
_ZN3m3d8anmVis_c4vf0CEv = 0x809B3540;
vf0C__Q23m3d8anmVis_cFv = 0x809B3540;
...
GameHeap0 = 0x803779C0;
GameHeap1 = 0x803779CC;
GameHeap2 = 0x803779D0;
WiimotePtr1 = 0x80377A08;

continueFromFlagObjCheck = 0x807EBA04;
returnFromFlagObjCheck = 0x807EBA1C;
...
daEnGakeNoko_c__StateID_FoolMove = 0x80B144E0;/*mi*/

EnItem_BindAnimation_Continued = 0x80A28B04;
...
daEnItem_c__GetWhetherPlayerCanGetPowerupOrNot = 0x80A2B780;/*mi*/
...
ExitFromTileGodHack = 0x807E1424;
...
_ZN9daEnemy_c6//__vtE = 0x80AE7B88;
//__vt__9daEnemy_c = 0x80AE7B88;
_ZN9daEnemy_c5_vf58Ev = 0x809A4DC0;
_vf58__9daEnemy_cFv = 0x809A4DC0;
_ZN9daEnemy_c5_vf5CEv = 0x809A4DB0;
_vf5C__9daEnemy_cFv = 0x809A4DB0;
_ZN9daEnemy_c5_vf68Ev = 0x809A4E00;
_vf68__9daEnemy_cFv = 0x809A4E00;
_ZN9daEnemy_c16ptrToWhichPlayerEv = 0x809A2E30;
ptrToWhichPlayer__9daEnemy_cFv = 0x809A2E30;
_ZN9daEnemy_c5_vf74Ev = 0x809A4DF0;
_vf74__9daEnemy_cFv = 0x809A4DF0;
_ZN9daEnemy_c5_vf7CEv = 0x809A4DE0;
_vf7C__9daEnemy_cFv = 0x809A4DE0;
_ZN9daEnemy_c5_vfB8Ev = 0x809A4DD0;
_vfB8__9daEnemy_cFv = 0x809A4DD0;
_ZN9daEnemy_c6_vf228Ev = 0x809A4E40;
_vf228__9daEnemy_cFv = 0x809A4E40;
_ZN9daEnemy_c6_vf23CEv = 0x809A4E30;
_vf23C__9daEnemy_cFv = 0x809A4E30;
_ZN9daEnemy_c6_vf240Ev = 0x809A4E20;
_vf240__9daEnemy_cFv = 0x809A4E20;
_ZN9daEnemy_c6_vf244Ev = 0x809A4E10;
_vf244__9daEnemy_cFv = 0x809A4E10;

/* daEnDosun_c */
__ct_11daEnDosun_cFv = 0x809F53B0;
__ct_14daEnBigDosun_cFv = 0x809F5440;
_ZTV11daEnDosun_c = 0x80AE7B48;
__vt__11daEnDosun_c = 0x80AE7B48;
_ZN11daEnDosun_c8onCreateEv = 0x809F54D0;
onCreate__11daEnDosun_cFv = 0x809F54D0;
_ZN11daEnDosun_c8onDeleteEv = 0x809F58B0;
onDelete__11daEnDosun_cFv = 0x809F58B0;
_ZN11daEnDosun_c9onExecuteEv = 0x809F5730;
onExecute__11daEnDosun_cFv = 0x809F5730;
_ZN11daEnDosun_c6onDrawEv = 0x809F5780;
onDraw__11daEnDosun_cFv = 0x809F5780;
__dt_11daEnDosun_cFv = 0x809F6A20;
_ZN11daEnDosun_c4killEv = 0x809F69F0;
kill__11daEnDosun_cFv = 0x809F69F0;
_ZN11daEnDosun_c18killedByLevelClearEv = 0x809F60F0;
killedByLevelClear__11daEnDosun_cFv = 0x809F60F0;
_ZN11daEnDosun_c23collisionCat3_StarPowerEP13ActivePhysicsS1_ = 0x809F5930;
collisionCat3_StarPower__11daEnDosun_cFP13ActivePhysicsP13ActivePhysics = 0x809F5930;
_ZN11daEnDosun_c6_vf108EP13ActivePhysicsS1_ = 0x809F58C0;
_vf108__11daEnDosun_cFP13ActivePhysicsP13ActivePhysics = 0x809F58C0;
_ZN11daEnDosun_c19collisionCatD_DrillEP13ActivePhysicsS1_ = 0x809F6A10;
collisionCatD_Drill__11daEnDosun_cFP13ActivePhysicsP13ActivePhysics = 0x809F6A10;
_ZN11daEnDosun_c6_vf110EP13ActivePhysicsS1_ = 0x809F5970;
_vf110__11daEnDosun_cFP13ActivePhysicsP13ActivePhysics = 0x809F5970;
_ZN11daEnDosun_c25collisionCat7_GroundPoundEP13ActivePhysicsS1_ = 0x809F6A00;
collisionCat7_GroundPound__11daEnDosun_cFP13ActivePhysicsP13ActivePhysics = 0x809F6A00;
_ZN11daEnDosun_c27collisionCat9_RollingObjectEP13ActivePhysicsS1_ = 0x809F6980;
collisionCat9_RollingObject__11daEnDosun_cFP13ActivePhysicsP13ActivePhysics = 0x809F6980;
_ZN11daEnDosun_c34collisionCat1_Fireball_E_ExplosionEP13ActivePhysicsS1_ = 0x809F69C0;
collisionCat1_Fireball_E_Explosion__11daEnDosun_cFP13ActivePhysicsP13ActivePhysics = 0x809F69C0;
_ZN11daEnDosun_c33collisionCat2_IceBall_15_YoshiIceEP13ActivePhysicsS1_ = 0x809F6990;
collisionCat2_IceBall_15_YoshiIce__11daEnDosun_cFP13ActivePhysicsP13ActivePhysics = 0x809F6990;
_ZN11daEnDosun_c6_vf144Ei = 0x809F5A00;
_vf144__11daEnDosun_cFi = 0x809F5A00;
_ZN11daEnDosun_c13DieFall_BeginEv = 0x809F66E0;
DieFall_Begin__11daEnDosun_cFv = 0x809F66E0;
_ZN11daEnDosun_c15DieFall_ExecuteEv = 0x809F67F0;
DieFall_Execute__11daEnDosun_cFv = 0x809F67F0;
_ZN11daEnDosun_c11DieFall_EndEv = 0x809F67E0;
DieFall_End__11daEnDosun_cFv = 0x809F67E0;
_ZN11daEnDosun_c9Ice_BeginEv = 0x809F6900;
Ice_Begin__11daEnDosun_cFv = 0x809F6900;
_ZN11daEnDosun_c11Ice_ExecuteEv = 0x809F6970;
Ice_Execute__11daEnDosun_cFv = 0x809F6970;
_ZN11daEnDosun_c7Ice_EndEv = 0x809F6960;
Ice_End__11daEnDosun_cFv = 0x809F6960;
_ZN11daEnDosun_c15CreateIceActorsEv = 0x809F5B40;
CreateIceActors__11daEnDosun_cFv = 0x809F5B40;
_ZN11daEnDosun_c14setupBodyModelEv = 0x809F5CD0;
setupBodyModel__11daEnDosun_cFv = 0x809F5CD0;
_ZN11daEnDosun_c10s_809F6530Ev = 0x809F5E10;
s_809F6530__11daEnDosun_cFv = 0x809F5E10;
_ZN11daEnDosun_c12spawnEffectsEv = 0x809F5F80;
spawnEffects__11daEnDosun_cFv = 0x809F5F80;
_ZN11daEnDosun_c14StateID_UpWaitE = 0x80B13C70;
StateID_UpWait__11daEnDosun_c = 0x80B13C70;
_ZN11daEnDosun_c20StateID_DownMoveWaitE = 0x80B13CB0;
StateID_DownMoveWait__11daEnDosun_c = 0x80B13CB0;
_ZN11daEnDosun_c16StateID_PuruMoveE = 0x80B13CF0;
StateID_PuruMove__11daEnDosun_c = 0x80B13CF0;
_ZN11daEnDosun_c23StateID_DownMove_KameckE = 0x80B13D30;
StateID_DownMove_Kameck__11daEnDosun_c = 0x80B13D30;
_ZN11daEnDosun_c16StateID_DownMoveE = 0x80B13D70;
StateID_DownMove__11daEnDosun_c = 0x80B13D70;
_ZN11daEnDosun_c16StateID_DownWaitE = 0x80B13DB0;
StateID_DownWait__11daEnDosun_c = 0x80B13DB0;
_ZN11daEnDosun_c14StateID_UpMoveE = 0x80B13DF0;
StateID_UpMove__11daEnDosun_c = 0x80B13DF0;
_ZN11daEnDosun_c15StateID_DieFallE = 0x80B13E2C;
StateID_DieFall__11daEnDosun_c = 0x80B13E2C;
_ZN11daEnDosun_c11StateID_IceE = 0x80B13E6C;
StateID_Ice__11daEnDosun_c = 0x80B13E6C;

SpawnThwompEffects = 0x809F5F80;
...
JrClownEndDemoState = 0x809992A8;
JrClownDemoWaitState = 0x809991A4;
...
doneWithAlternateCRSINLYTSetup = 0x8091EA90;
doneWithAlternateCRSINLYTSetup2 = 0x8091EA94;
doneWithAlternateCRSINLYTExecute = 0x8091EF9C;
doneWithAlternateCRSINLYTExecute2 = 0x8091EFA0;
doneWithAlternateCRSINLYTDraw = 0x8091F290;
doneWithAlternateCRSINLYTDraw2 = 0x8091F294;
doneWithAlternateCRSINLYTDelete = 0x8091F1F8;
doneWithAlternateCRSINLYTDelete2 = 0x8091F1FC;
doneWithSetAlternateCRSINLYTByte = 0x80101818;
doneWithPatchNoPreGameShit = 0x80101810;
doneWithNoCRSINWipe = 0x8091EE68;
doneWithNoCRSINWipe2 = 0x8091EE6C;
doneWithBlockGameLanguage = 0x800B4608;/*pal*/
doneWithBlockGameLanguage = 0x800B4608;/*pal2*/
doneWithBlockGameLanguage = 0x800B45EC;/*ntsc*/
doneWithBlockGameLanguage = 0x800B45EC;/*ntsc2*/

GetGameLanguage = 0x800B45E0;/*pal*/
GetGameLanguage = 0x800B45E0;/*pal2*/
GetGameLanguage = 0x800B45C0;/*ntsc*/
GetGameLanguage = 0x800B45C0;/*ntsc2*/
GetGameLanguage = 0x800B45C0;/*jpn*/
GetGameLanguage = 0x800B45C0;/*jpn2*/
...
_ZN3m2d13EmbedLayout_c11disableAnimEi = 0x800C9410;
disableAnim__Q23m2d13EmbedLayout_cFi = 0x800C9410;
_ZN3m2d11FrameCtrl_c15setCurrentFrameEf = 0x801635E0;
setCurrentFrame__Q23m2d11FrameCtrl_cFf = 0x801635E0;
_ZN3m2d11FrameCtrl_c11processAnimEv = 0x801634D0;
processAnim__Q23m2d11FrameCtrl_cFv = 0x801634D0;
_ZN3m2d5Anm_c24updateAssociatedElementsEv = 0x801642E0;/*addAnyway*/
...
_Z13GetBMGMessageii = 0x800CDBC0;
GetBMGMessage__Fii = 0x800CDBC0;
loadBMGStringToMyBuffer = 0x800E6940;

AssembleDefaultScWorldMapSettings = 0x801029C0;		/*idk :D*/

/*Add custom SFXs*/
NewSFXTable = 0x8044FA40;
NewSFXIndexes = 0x8045FA40;
doneWithNewSFXHax = 0x802839B4;
PlaySoundWithFunctionB4_2 = 0x80194EB4;
...
/* related MiniGames things */
doBGMStuff = 0x8019C810;
doBGMStuff2 = 0x8019CA80;
NextStageActorDisableFlags = 0x80429A18;

/* related MiniGame_ItemBowling things */
doneWithNoPlayerGP = 0x801265A0;
doneWithNoPlayerGP2 = 0x80126524;
doneWithNoPlayerFire = 0x8011AD38;
doneWithNoPlayerIce = 0x801243D8;
doneWithNoPlayerSpin = 0x80146FB8;
doneWithNoPlayerSpin2 = 0x80147040;
doneWithNoPlayerSlide = 0x8012D34C;
doneWithNoPlayerSlide2 = 0x8012D374;
doneWithGPSlide = 0x80039BF4;
doGPSlide = 0x80038D4C;
unk_80353CD8 = 0x80353758;
/* MiniGame_ItemBowling Shell Physics */
doneWithBounceShell = 0x8003B9B4;
doneWithDoCloudBounceAnim = 0x80A5C3A8;
actuallyDoCloudBounceAnim = 0x80A5C3B8;
doneWithSpringboardShell = 0x80038924;
ShellSlideState = 0x803537E4;
...
pow = 0x802E53B4;
_ZN9EN_BUBBLE14onExecute_origEv = 0x809D00C0;
onExecute_orig__9EN_BUBBLEFv = 0x809D00C0;
_ZN7WLClass20activateStandardAnimEv = 0x8005CE50;
...
/*reverse assembled*/
addRest = 0x80060460;
incRestAll = 0x800E1F48;
oneUPPopup = 0x800B35B0;
DisplayScoreAddPopup = 0x800B3540;
AddScore = 0x80060690;
zoneZoomFloat = 0x8042BA70;

aP_rcha_2 = 0x8098BD34;
aWm_mr_iceball_ = 0x80311940;
aWm_mr_icebal_0 = 0x80311950;
...
_ZN7fBase_c17searchByProfileIdEtPS_ = 0x80162B60;
searchByProfileId__7fBase_cFUsP7fBase_c = 0x80162B60;

/*projectiles piranha plant*/
continuePakkunNormal = 0x8002FA74;
continuePakkunBony = 0x8002FB74;
_ZN5dEn_c15fireballInvalidEP13ActivePhysicsS1_ = 0x80097E50;
fireballInvalid__5dEn_cFP13ActivePhysicsP13ActivePhysics = 0x80097E50;
_ZN5dEn_c14iceballInvalidEP13ActivePhysicsS1_ = 0x80097EA0;
...
_ZN14dPlayerInput_c13getPressedTwoEv = 0x8005E570;
getPressedTwo__14dPlayerInput_cFv = 0x8005E570;
_ZN14dPlayerInput_c10getHeldTwoEv = 0x8005E580;
getHeldTwo__14dPlayerInput_cFv = 0x8005E580;
_ZN14dPlayerInput_c10getHeldTwoEv = 0x8005E580;/*addAnyway*/

/* dActor_c */
_ZN8dActor_c18doSearchNearPlayerEP7Point2dS1_ = 0x80064790;
doSearchNearPlayer__8dActor_cFP7Point2dP7Point2d = 0x80064790;

/*45 cannon extension*/
shotBombs = 0x808A12C4;
thisisball = 0x808A1290;
thisisbomb = 0x808A12A4;
daEnShell_cinitializeState_Slide = 0x8003B3E0;

/*Giant Light Block*/
LAB_800619cc = 0x800619CC;
LAB_800619d4 = 0x800619D4;
LAB_807c0878 = 0x807C0618;

/*daTorchiLight_c*/
daTorchiLight_c_onCreate_this318 = 0x808B0B50;

/* daJrClownForPlayer_c */
daJrClownForPlayer_c_usePlayer = 0x80810B20;

/* daBrosIceball */
daBrosIceball_executeState_Move_deleteRequest = 0x807D53E4;
daBrosIceball_spawnMisshitEffect = 0x807D5200;
setUnkFlag_FUN_807d51d0	= 0x807d5288;

/* dBg_ctr_c */
dBg_ctr_c_set_circle = 0x8007FB80;

/*WmLib*/
m_goalType = 0x80429F1C;
