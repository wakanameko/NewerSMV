#include "minigame_CollectStar.h"
#include "boss.h"


CREATE_STATE(dCollectStarMgr_c, Init);
CREATE_STATE(dCollectStarMgr_c, ShowTitle);
CREATE_STATE(dCollectStarMgr_c, HideTitle);
CREATE_STATE(dCollectStarMgr_c, ShowRules);
CREATE_STATE(dCollectStarMgr_c, HideRules);
CREATE_STATE(dCollectStarMgr_c, WaitForThrow);
CREATE_STATE(dCollectStarMgr_c, WaitForShellDeath);
CREATE_STATE(dCollectStarMgr_c, FollowShell);
CREATE_STATE(dCollectStarMgr_c, GetResults);
CREATE_STATE(dCollectStarMgr_c, WaitForResults);
CREATE_STATE(dCollectStarMgr_c, End);

dCollectStarMgr_c *dCollectStarMgr_c::instance = 0;

dActor_c *dCollectStarMgr_c::build() {
	void *buffer = AllocFromGameHeap1(sizeof(dCollectStarMgr_c));
	dCollectStarMgr_c *c = new(buffer) dCollectStarMgr_c;

	instance = c;
	return c;
}

const SpriteData minigameCSMgrSpriteData = { ProfileId::minigameCollectStarMgr, 0, 0, 0, 0, 0x100, 0x100, 0, 0, 0, 0, 0 };
Profile minigameCSMgrProfile(&dCollectStarMgr_c::build, SpriteId::minigameCollectStarMgr, &minigameCSMgrSpriteData, ProfileId::minigameCollectStarMgr, ProfileId::minigameCollectStarMgr, "minigameCollectStarMgr", minigameCollectStarMgrArcNameList, 0x20);
...
int dCollectStarMgr_c::onCreate() {
	if(!layoutLoaded) {
...
int dCollectStarMgr_c::onDelete() {
	isInItemBowling = false;
	return layout.free();
}

int dCollectStarMgr_c::onDraw() {
	if (isVisible) {
...
int dCollectStarMgr_c::onExecute() {
	acState.execute();
...
void dCollectStarMgr_c::beginState_Init() {
	this->hideAll();
...
void dCollectStarMgr_c::executeState_Init() {
...
void dCollectStarMgr_c::endState_Init() {
	
}

// ShowTitle State

void dCollectStarMgr_c::beginState_ShowTitle() {
	OSReport("ShowTitle Item Bowling.\n");
	this->timer = 0;
}

void dCollectStarMgr_c::executeState_ShowTitle() {
...
void dCollectStarMgr_c::endState_ShowTitle() {
	
}

// HideTitle State

void dCollectStarMgr_c::beginState_HideTitle() {
	OSReport("HideTitle Item Bowling.\n");
	this->timer = 0;
}

void dCollectStarMgr_c::executeState_HideTitle() {
...
void dCollectStarMgr_c::endState_HideTitle() {
	
}

// ShowRules State

void dCollectStarMgr_c::beginState_ShowRules() {
	OSReport("ShowRules Item Bowling.\n");

}

void dCollectStarMgr_c::executeState_ShowRules() {
...
void dCollectStarMgr_c::endState_ShowRules() {
	
}

// HideRules State

void dCollectStarMgr_c::beginState_HideRules() {
	OSReport("HideRules Item Bowling.\n");

}

void dCollectStarMgr_c::executeState_HideRules() {
...
void dCollectStarMgr_c::endState_HideRules() {
	// layout.resetAnim(SHOW_ALL);
	// layout.resetAnim(SHOW_TITLE);
	// layout.disableAllAnimations();
}
...
void dCollectStarMgr_c::beginState_WaitForThrow() {
...
void dCollectStarMgr_c::executeState_WaitForThrow() {
...
void dCollectStarMgr_c::endState_WaitForThrow() {
	
}

// WaitForShellDeath State

void dCollectStarMgr_c::beginState_WaitForShellDeath() {
	OSReport("WaitForShellDeath Item Bowling.\n");
}

void dCollectStarMgr_c::executeState_WaitForShellDeath() {
}

void dCollectStarMgr_c::endState_WaitForShellDeath() {
	
}

// FollowShell State

void dCollectStarMgr_c::beginState_FollowShell() {
...
void dCollectStarMgr_c::executeState_FollowShell() {
	if(this->timer == 80) {
		NextStageActorDisableFlags |= 0x10;
	}
...
void dCollectStarMgr_c::endState_FollowShell() {
	
}

// GetResults State

void dCollectStarMgr_c::beginState_GetResults() {
	OSReport("GetResults Item Bowling.\n");
}

void dCollectStarMgr_c::executeState_GetResults() {
...
void dCollectStarMgr_c::endState_GetResults() {
	
}

// WaitForResults State

void dCollectStarMgr_c::beginState_WaitForResults() {
	OSReport("WaitForResults Item Bowling.\n");
}

void dCollectStarMgr_c::executeState_WaitForResults() {
...
void dCollectStarMgr_c::endState_WaitForResults() {
	
}

// End State

void dCollectStarMgr_c::beginState_End() {
	OSReport("End Item Bowling.\n");
	this->timer = 0;
}

void dCollectStarMgr_c::executeState_End() {
	if(!layout.isAnimOn(HIDE_ALL)) {
		if(this->timer == 60) {
...
void dCollectStarMgr_c::endState_End() {
...
void dCollectStarMgr_c::showLose() {
	N_info_00->SetVisible(false);
	N_result_00->SetVisible(false);
	N_result_01->SetVisible(true);
}

void dCollectStarMgr_c::hideAll() {
	N_info_00->SetVisible(false);
	N_result_00->SetVisible(false);
	N_result_01->SetVisible(false);
}