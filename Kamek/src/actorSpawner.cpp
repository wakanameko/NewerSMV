...
const SpriteData actorSpawnerData = {ProfileId::NEWER_ACTORSPAWNER, 8, -8, 0, 0, 0x100, 0x100, 0, 0, 0, 0, 2};
Profile actorSpawnerProfile(&dActorSpawner_c::build, SpriteId::NEWER_ACTORSPAWNER, &actorSpawnerData, ProfileId::NEWER_ACTORSPAWNER, ProfileId::NEWER_ACTORSPAWNER, "NEWER_ACTORSPAWNER", NULL, 0);
...
dActorSpawner_c* dActorSpawner_c::findCorrespondingDataBank() {
	...
	while (true) {
		...
		dataBank = (dActorSpawner_c*) fBase_c::search((Actors)ProfileId::NEWER_ACTORSPAWNER, dataBank);
