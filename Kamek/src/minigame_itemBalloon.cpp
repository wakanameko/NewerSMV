...
dActor_c *dItemBalloon_c::build() {
	void *buffer = AllocFromGameHeap1(sizeof(dItemBalloon_c));
	return new(buffer) dItemBalloon_c;
}

const SpriteData minigameItemBalloonData = {ProfileId::ITEMBALLOON, 0, 0, 0, 0, 0x1000, 0x1000, 0, 0, 0, 0, 2}; 
Profile minigameItemBalloonProfile(&dItemBalloon_c::build, SpriteId::ITEMBALLOON, &minigameItemBalloonData, ProfileId::ITEMBALLOON, ProfileId::ITEMBALLOON, "ITEMBALLOON", IBarcNameList, 0);
