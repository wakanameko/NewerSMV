...
int daSpikeTrap_c::onCreate() {
	...
	colliderInfo.otherCallback1 = (void*)&SpikeTrapPhysBelowCB1;
	colliderInfo.otherCallback2 = (void*)&SpikeTrapPhysAboveCB1;
	colliderInfo.otherCallback3 = (void*)&SpikeTrapPhysAjdCB1;
...
void daSpikeTrap_c::beginState_Attack() {
	...
	if (!this->disableSFX) playSoundDistance(&this->handle, this->pos, SE_PLY_WALK_METAL, 1.0, 1.0, 500.0);
