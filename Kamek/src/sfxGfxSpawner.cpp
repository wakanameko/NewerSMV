...
class dSfxGfxSpawner_c : public dEn_c {
public:
	int onCreate();
	int onExecute();
	int onDelete();
...
dActor_c *dSfxGfxSpawner_c::build() {
	void *buffer = AllocFromGameHeap1(sizeof(dSfxGfxSpawner_c));
	return new(buffer) dSfxGfxSpawner_c;
}

#include <profile.h>
const SpriteData sfxgfxSpawnerData = {ProfileId::NEWER_SFXGFXSPAWNER, 8, -8, 0, 0, 0x100, 0x100, 0, 0, 0, 0, 2};
Profile sfxgfxSpawnerProfile(&dSfxGfxSpawner_c::build, SpriteId::NEWER_SFXGFXSPAWNER, &sfxgfxSpawnerData, ProfileId::NEWER_SFXGFXSPAWNER, ProfileId::NEWER_SFXGFXSPAWNER, "NEWER_SFXGFXSPAWNER", NULL, 0);



int dSfxGfxSpawner_c::onCreate() {
	this->timer = 0;
...
int dSfxGfxSpawner_c::onDelete() {
	return true;
}


int dSfxGfxSpawner_c::onExecute() {
