...
int daSMWBBB_c::onCreate() {
	...
	this->BasePos = {this->pos.x, this->pos.y};
	this->Hiding = 1;
	this->dying = 0;
	this->timerY = 0;
	this->timerX = 0;
	...
	OSReport("triggerIDs: ON->%d, OFF->%d, DEFEAT->%d\n", triggerID_ON, triggerID_OFF, triggerID_DEFEAT);
