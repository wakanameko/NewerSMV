...
// better muncher sprite by Synel and modded by wakanameko
...
class dMuncher_c : public dEn_c {
	...
	bool walldamage;	// Added by wakanameko
	s16 colRot;
...
int dMuncher_c::onCreate() {
	...
	this->effectScale = (Vec){0.5f * this->scale.x, 0.5f * this->scale.x, 0.5f * this->scale.x};
